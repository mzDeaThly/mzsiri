...
async def on_ready():
    ...
    bot.qa_data = {
        ...
        "ใครกล้วยาย": "ใครกล้ายาย : กอก้า กล้า กลัวยายไง",
        "เป็นอะไร": "เป็นอะไร ทำไมไม่เหมือนเดิม? : เขา เปลี่ยนไปนานแล้ว แต่ไม่มีใครสังเกต",
        "ใครไม่ชอบออกตัดเลือด": "ใครไม่ชอบออกตัดเลือด : โอ้ คำถามนี้ ถือว่าถามได้ดีเลย จากการประมวลผลใน Server Family Game 24 Hrs. แล้ว สรุปได้ว่า คนที่ไม่ชอบออกตัดเลือดคือ ตระกูล ม.ม้า นะคะ โมเดล เมษา เมเปิ้ล ค่ะ",
